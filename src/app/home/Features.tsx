...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "Unified Recruitment Hub is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "U.S. Best Practices",
    text: "Unified Recruitment Hub has built-in best practices for the U.S. job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "Unified Recruitment Hub stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
    ...
    text: (
      <>
        Unified Recruitment Hub is an open-source project, and its source code can be viewed
        by anyone on its{" "}
