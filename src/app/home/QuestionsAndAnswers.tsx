...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Unified Recruitment Hub saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Unified Recruitment Hub apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Unified Recruitment Hub, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Unified Recruitment Hub
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Unified Recruitment Hub is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Unified Recruitment Hub intentionally only offers
          ...
          like references. Additionally, Unified Recruitment Hub only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Unified Recruitment Hub is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Unified Recruitment Hub believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Unified Recruitment Hub doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created Unified Recruitment Hub and why?",
    answer: (
      <p>
        Unified Recruitment Hub was created by{" "}
        ...
        that led to Unified Recruitment Hub, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Unified Recruitment Hub can help
  ...
  {
    question: "Q4. How can I support Unified Recruitment Hub?",
    answer: (
      <>
        <p>
          The best way to support Unified Recruitment Hub is to share your thoughts and
        ...
        <p>
          Another great way to support Unified Recruitment Hub is by spreading the words.
