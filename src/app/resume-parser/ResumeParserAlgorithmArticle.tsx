  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Unified Recruitment Hub
      ...
      <Paragraph>
        And that is everything about the Unified Recruitment Hub parser algorithm :)
      </Paragraph>
      <Paragraph>
